      ...
      <div className="Contenedor">
        ...
        <div className="foto">
          <img
            ...
            src={filmDetails.image ? filmDetails.image : Logo}
            alt=""
          />
          ...
          <p className="valores">
            {filmDetails.rating ? filmDetails.rating : 0}
          </p>

          <GroupsIcon color="azul" sx={{ fontSize: 40 }} className="icono2" />
          <p className="valores2">
            {filmDetails.popularity ? filmDetails.popularity : 0}
          </p>
              ...
              <div className="logeado">
                <div className="interacción">
                  ...
                  <Fab color="azul" aria-label="like" onClick={save}>
                    {guardado ? <AccessTimeFilledIcon /> : <MoreTimeIcon />}
                  </Fab>
                  <br></br>
                  <br></br>
                  <Fab color="amarillo" aria-label="like" onClick={list}>
                    {playlist ? <PlaylistAddCheckIcon /> : <PlaylistAddIcon />}
                  </Fab>
                </div>
          ...
          <Tabs className="tabs" id="controlled-tab-example">
            <Tab eventKey="contact" title="GENRES">
              {filmDetails.length !== 0
                ? filmDetails.genres.map((a) => a.name + ", ")
                : null}
            </Tab>
            <Tab eventKey="profile" title="DETAILS" className="cast">
              ...
              <li>
                DURATION: <br></br>
                {(filmDetails.length / 60).toFixed(2)} hr
              </li>
              <br></br>
              <li>
                RELEASED DATE: <br></br>
            ...
            <Tab eventKey="home" title="CAST" className="cast">
              <li>
                DIRECTOR: <br></br>
                {filmDetails.length !== 0
                  ? filmDetails.fullCast.director.name
                  : null}
                .
              </li>
              <br></br>
              <li>
                CAST: <br></br>
                {filmDetails.length !== 0
                  ? filmDetails.fullCast.cast.map((a) => a.name + "," + " ")
                  : null}
                .
              </li>
              <br></br>
              <li>
                PRODUCERS: <br></br>
                {filmDetails.length !== 0
                  ? filmDetails.fullCast.producers.map(
                      (a) => a.name + "," + " "
                    )
                  : null}
                .
          ...
          <div className="trailer">
            <a href={filmDetails.trailer} target="_blank">
              <Button variant="text" color="rojo">
                {" "}
                <YouTubeIcon fontSize="large" /> watch movie preview
              </Button>
            </a>
          </div>
        </div>
